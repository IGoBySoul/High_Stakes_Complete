...
lcdButton redNegElims(xplace2,135,120,40, "Red Negative Elims", "FF2525", "#FFFFFF", 2);
lcdButton redPosElims(xplace2,180,120,40, "Red Positive Elims", "FF2525", "#FFFFFF", 2);
lcdButton blueNegElims(1000,135,120,40, "Blue Negative Elims", "2525FF", "#FFFFFF", 2);
lcdButton bluePosElims(1000,135,120,40, "Blue Positive Elims", "2525FF", "#FFFFFF", 2);
